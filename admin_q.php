...
<h4 class="text-center"> please choose from these choices: </h4>
  <a class="btn text-light button  btn-lg btn-block" href="admin_browsing.php">edit on admins database</a>
